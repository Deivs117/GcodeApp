...
func main() {
	...
	sched.Put("/meetings/:id", withDB(calendar.HandleUpdateMeeting))
	...
	cnc.Put("/clients/:id", withDB(reports.HandleUpdateClient))
	cnc.Delete("/clients/:id", withDB(reports.HandleDeleteClient))
	cnc.Get("/pcb-versions", withDB(reports.HandleListPcbVersions))
	cnc.Post("/pcb-versions", withDB(reports.HandleCreatePcbVersion))
	cnc.Put("/pcb-versions/:id", withDB(reports.HandleUpdatePcbVersion))
	cnc.Delete("/pcb-versions/:id", withDB(reports.HandleDeletePcbVersion))
